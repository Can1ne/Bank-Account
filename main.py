...
savings1 = SavingsAccount("Brendon Kaas", 2000, 50, "11111", "987654", 0.05)
savings1.apply_interest()
savings1.print_customer_information()

print("\n")

savings2 = SavingsAccount("Akash Simmons", 1500, 50, "22222", "987654", 0.04)
savings2.apply_interest()
savings2.print_customer_information()

print("\n")

checking1 = CheckingAccount("Professor Mohsen", 5000, 100, "33333", "987654", 1000)
...
checking2 = CheckingAccount("Brendon Kaas", 1000, 50, "44444", "987654", 300)
